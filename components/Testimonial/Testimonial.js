        ...
        className = '!pb-14 ' > {
            carosuelPoint.map(item => {
                ...
                return ( <
                    ...
                    /div> <
                    h3 className = 'text-base md:text-2xl text-center' > { review } <
                    /h3> <
