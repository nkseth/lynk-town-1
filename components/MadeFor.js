...
const MadeFor = () => {
    return ( <
        ...
        for you <
        /h4> <
        svg className = 'absolute left-2/4 top-[-8px] translate-x-[-52%]  md:hidden'
        width = '118'
        height = '43'
        viewBox = '0 0 118 43'
        fill = 'none'
        ...
        <
        svg className = 'absolute left-2/4 top-[-8px] translate-x-[-52%] hidden md:block'
        width = '204.72'
        height = '72.35'
        viewBox = '0 0 211 78'
        fill = 'none'
        ...
        img src = { image4.src }
        alt = ''
        className = 'hidden md:block absolute rounded-[7.78px] h-[156.76px] w-[157.38px] sm:w-[206.76px] sm:h-[250px] md:w-auto md:h-auto top-10 left-[2%] sm:left-[5%] sm:top-[-50px] md:left-[20%] md:top-40 object-cover z-10' /
        >
        <
        img src = { image5.src }
        alt = ''
        ...
        img src = { image6.src }
        alt = ''
        className = 'absolute rounded-[15.78px]   h-[154.63px] w-[153.45px]  sm:w-[230px] sm:h-[250px] md:w-auto md:h-auto     bottom-[-150px]   sm:bottom-0  left-[40%] md:left-[5%] md:bottom-0 object-cover' /
        >
        <
        /div> < /
        section >
