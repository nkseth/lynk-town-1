            ...
            >
            {
                largeScreen ? ( <
                    ManageBusinessMobile / >
                        ...
                        div ref = { ref }
                        className = 'wrapper relative pt-36  pb-28 px-4' >
                        <
                        ...
                        <
                        div className = 'w-[2px]  h-full bg-[#D9D9D9] absolute left-3 z-[-1]'
                        style = {
                            {
                                            ...
                                            style = {
                                                {
                                                    ...
                                                    cursor: clicked[id - 1] && !clicked[id + 1] && !running ?
                                                        'pointer' : '',
                                                }
                                            }
                                            onClick = {
                ...
                <
                svg className = 'w-[400px] h-[400px] xl:w-[474px] xl:h-[400px]'
                viewBox = '0 0 474 474'
                fill = 'none'
