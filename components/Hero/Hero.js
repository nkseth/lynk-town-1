...
const Hero = () => {
    return ( <
        section className = 'lg:h-[655px]  pt-5  sm:pt-12 lg:py-4   bg-primaryColor text-white relative' >
        <
        div className = 'container mx-auto grid lg:grid-cols-2 h-full items-center px-4' >
        <
        div >
        <
        ...
        className = 'w-full h-full sm:w-[350px] sm:h-[350px] md:w-[495px] md:h-[495px]'
        viewBox = '0 0 475 475'
        fill = 'none'
        ...
        fill = '#6A5B40' / >
        <
        path d = 'M20.4238 14.134C21.0905 14.5189 21.0905 15.4811 20.4238 15.866L13.0392 20.1295C12.3725 20.5144 11.5392 20.0333 11.5392 19.2635L11.5392 10.7365C11.5392 9.96667 12.3725 9.48555 13.0392 9.87045L20.4238 14.134Z'
        fill = 'white' /
        >
        <
        /svg>{' '}
