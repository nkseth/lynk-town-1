...
const Community = () => {
    return ( <
        ...
        <
        div className = 'h-[485.7px] md:h-full row-span-full bg-cover w-full  relative rounded-[24px]'
        style = {
            {
                width: '575px',
                height: '850px',
        ...
        <
        h4 >
        Be a part of a creative business community to collaborate and grow your business <
        /h4> < /
        div > <
        /div> <
        div className = 'bg-cover  h-[250.7px] md:h-full md:w-full  rounded-[24px] community__img--2 relative'
        style = {
            {
                width: '575px',
                height: '409px',
        ...
        <
        h4 >
        Get real world insights and daily tips to help you with your branding and marketing <
        /h4> < /
        div > <
        /div> <
        div className = 'bg-cover w-full h-[250.7px] md:h-full  rounded-[24px] relative  cursor-pointer community__img--3'
        style = {
            {
                width: '575px',
                height: '409px',
        ...
        <
        h4 >
        Build your business with a platform trusted by 1000 s of sellers from all over the world <
        /h4> < /
        div > <
        /div> < /
        div > <
        ...
        Know more <
        div className = 'absolute right-[-25px] md:right-[-55px] md:top-[-10px]' >
        <
        Instagram / >
        <
        /div> < /
